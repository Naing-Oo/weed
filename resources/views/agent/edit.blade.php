        ...
        <form method="POST" action="{{ route('agents.update', $agent->id) }}">
            ...
            <div class="row">
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="first_name" placeholder="First Name" aria-describedby="firstNameHelp" value="{{ old('first_name')? old('first_name'): $agent->first_name }}">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="last_name" placeholder="Last Name" aria-describedby="lastNameHelp" value="{{ old('last_name')? old('last_name'): $agent->last_name }}">
            ...
            <div class="row">
                <div class="col-lg-6  mb-3">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="Email" aria-describedby="emailHelp" readonly value="{{ old('email')? old('email'): $agent->email }}">
                    @if($errors->has('email'))
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="text" class="form-control" name="phone" placeholder="Phone" aria-describedby="phoneHelp" value="{{ old('phone')? old('phone'): $agent->phone }}">
                    @if($errors->has('phone'))
            ...
            <div class="row">
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="join_date" placeholder="mm/dd/yyyy" aria-describedby="joinDateHelp" value="{{ old('join_date')? old('join_date'): $agent->join_date }}">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" name="resign_date" placeholder="mm/dd/yyyy" aria-describedby="resignDateHelp" value="{{ old('resign_date')? old('resign_date'): $agent->resign_date }}">
                        <div class="input-group-append">
                            <span class="input-group-text h-100">
                                <i class="mdi mdi-calendar"></i>
                            </span>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input type="number" class="form-control" name="commission_rate" placeholder="Commission Rate" aria-describedby="commissionRateHelp" 
                         value="{{ old('commission_rate')? old('commission_rate'): $agent->commission_rate }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="address" placeholder="Address" aria-describedby="addressHelp" value="{{ old('address')? old('address'): $agent->address }}">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="remark" placeholder="Remark" rows="3" aria-describedby="remark">{{ old('remark')? old('remark'): $agent->remark }}</textarea>
