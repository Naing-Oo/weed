        ...
        <div class="navbar-header" data-logobg="skin5">
            <!-- Logo -->
                <a class="navbar-brand" href="">
                    ...
                    <!-- Dark Logo icon -->
                    <!-- <img
                        src="{{ asset('storage/matrix-admin/assets/images/logo-icon.png') }}"
                        alt="homepage"
                        class="light-logo"
                        width="25"
                    /> -->
                    ...
                    <!-- dark Logo text -->
                    <!-- <img
                        src="{{ asset('storage/matrix-admin/assets/images/logo-text.png') }}"
                        alt="homepage"
                        class="light-logo"
                    /> -->
                    WE EDUCATION
                ...
                <!-- ============================================================== -->
                    <!-- <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="">New Agent</a></li>
                ...
                <!-- User profile and search -->
                    <li class="nav-item dropdown">
                        ...
                        >
                            ...
                            <img src="{{ asset('storage/matrix-admin/assets/images/users/1.jpg') }}"
                            alt="user"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                            ...
                            <!-- <a class="dropdown-item" href="javascript:void(0)">
                                <i class="mdi mdi-wallet me-1 ms-1"></i> 
                                My Balance
                            </a> -->

                            <!-- <a class="dropdown-item" href="javascript:void(0)">
                                <i class="mdi mdi-email me-1 ms-1"></i> 
                                Inbox
                            </a> -->
                            ...
                            <!-- <div class="dropdown-divider"></div>
                                <div class="ps-4 p-10">
                                    <a href="javascript:void(0)" class="btn btn-sm btn-success btn-rounded text-white">
                                        View Profile
                                    </a>
                                </div> -->
                        </ul>
